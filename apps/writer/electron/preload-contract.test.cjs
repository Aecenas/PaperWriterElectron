...
const INVOKE_CONTRACTS = [
  ...
  ["getHelpAssistantState", [], ["help-ai:get-state"]],
  ["createHelpAssistantSession", [], ["help-ai:create-session"]],
  ["setActiveHelpAssistantSession", ["help-session-1"], ["help-ai:set-active-session", "help-session-1"]],
  ["renameHelpAssistantSession", [payload], ["help-ai:rename-session", payload]],
  ["deleteHelpAssistantSession", ["help-session-1"], ["help-ai:delete-session", "help-session-1"]],
  ["generateHelpAssistant", [payload], ["help-ai:generate", payload]],
  ["cancelHelpAssistant", ["ai-help-1"], ["help-ai:cancel", "ai-help-1"]],
  ...
  ["translateResearchContent", [payload], ["research-translation:translate", payload]],
  ["cancelResearchTranslation", ["ai-research-translation-test-123456"], ["research-translation:cancel", "ai-research-translation-test-123456"]],
  ["exportAiChat", [payload], ["ai:export-chat", payload]],
  ["routeAiCollaboration", [payload], ["ai-collaboration:route", payload]],
  ["planAiCollaboration", [payload], ["ai-collaboration:plan", payload]],
  ["cancelAiCollaboration", ["ai-collaboration-1"], ["ai-collaboration:cancel", "ai-collaboration-1"]],
  ["validateAiCollaborationProposal", [payload], ["ai-collaboration:validate", payload]],
  ["prepareAiCollaborationCommit", [payload], ["ai-collaboration:prepare", payload]],
  ["commitAiCollaboration", ["commit-1"], ["ai-collaboration:commit", "commit-1"]],
  ["abortAiCollaborationCommit", ["commit-1"], ["ai-collaboration:abort", "commit-1"]],
  ...
  ["copyImageToClipboard", [{ x: 42, y: 91, src: "data:image/png;base64,AA==" }], ["clipboard:copy-image-at", { x: 42, y: 91 }]],
...
const EVENT_CONTRACTS = [
  ...
  ["onAiCollaborationEvent", "ai-collaboration:event", false],
  ["onAiDone", "ai:done", false],
  ["onAiError", "ai:error", false],
  ["onHelpAssistantChunk", "help-ai:chunk", false],
  ["onHelpAssistantDone", "help-ai:done", false],
  ["onHelpAssistantError", "help-ai:error", false],
  ...
  ["onResearchTranslationProgress", "research-translation:progress", false],
