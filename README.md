...
- **研究写作**：资料区按“资料区位置 / 资料 / 网页”管理独立目录中的文件和网页来源；结构页集中处理可折叠大纲、脚注、关联笺记、书签和私域 / 公域文献库，并支持多种书目格式、引用样式与 DOI / ISBN 补全。
- **AI 功能**：支持 AI 优化、AI 问答和 AI 起稿；选区问答保持轻量隔离，优化结果可在红蓝对比后安全应用，AI 起稿则从简报和明确选择的参考资料生成一封不覆盖原稿的新信笺。
